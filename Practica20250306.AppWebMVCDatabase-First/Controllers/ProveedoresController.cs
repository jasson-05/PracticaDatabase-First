...
using Practica20250306.AppWebMVCDatabase_First.Models;

namespace Practica20250306.AppWebMVCDatabase_First.Controllers
{
    public class ProveedoresController : Controller
    {
        private readonly CatalogosDbContext _context;

        public ProveedoresController(CatalogosDbContext context)
        {
            _context = context;
        }
